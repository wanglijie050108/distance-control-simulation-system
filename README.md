# 距离测控仿真系统（23009200496 王李杰）

## 已完成

- Arduino 程序：读取 GP2D12 距离、LCD 显示、串口双向通信、电机启停控制。
- 个人阈值：`30 + 学号末位 6 = 36 cm`。
...
- `proteus/DisDetectSys_23009200496.pdsprj`：已接入固件的 Proteus 工程。
...
- `report/23009200496_王李杰_计算机科学与技术学院_线上A测报告_待补截图.docx`：待插入两张截图的报告。
...
9. 将测试结论中的“待完成两组 Proteus 联调截图后填写：”删除，然后导出 PDF，文件名改为：
   `23009200496_王李杰_计算机科学与技术学院_线上A测报告.pdf`
